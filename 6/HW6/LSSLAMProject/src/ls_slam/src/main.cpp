...
int main(int argc, char** argv)
{
    ...
    beforeGraphPub = nodeHandle.advertise<visualization_msgs::MarkerArray>("beforePoseGraph_gn", 1, true);
    afterGraphPub = nodeHandle.advertise<visualization_msgs::MarkerArray>("afterPoseGraph_gn", 1, true);

    std::string VertexPath = "/home/sunm/work/code/shenlan-2d/6/HW6/LSSLAMProject/src/ls_slam/data/test_quadrat-v.dat";
    std::string EdgePath = "/home/sunm/work/code/shenlan-2d/6/HW6/LSSLAMProject/src/ls_slam/data/test_quadrat-e.dat";

    // std::string VertexPath = "/home/sunm/work/code/shenlan-2d/6/HW6/LSSLAMProject/src/ls_slam/data/killian-v.dat";
    // std::string EdgePath = "/home/sunm/work/code/shenlan-2d/6/HW6/LSSLAMProject/src/ls_slam/data/killian-e.dat";
    ...
    for (int i = 0; i < maxIteration; i++) {
        ...
        std::cout << "-error: " << ComputeError(Vertexs, Edges) << std::endl;
